...
#                 if product_type_id == int(i.split()[1]):
#                     # Update the string with the elements after the second one
#                     helper1= int(i.split()[2]) - 1
#                     helper2 = " ".join(i.split()[3:])
#                     line = (str(helper1) + " " + str(helper2) + "\n")
#                     names[helper1] = i.split()[0]

#                 else:
#                     if not line: # if the string is empty
#                         line = "" # string should stay empty
#                         lines.append(line)
#                 lines.append(line)
#             print(lines)
...
# create_yolo_training_config("C:/Users/Liva Ausma/Documents/WORK/DFKI/DVC/AI/training_folder/dataset", product_specific=True, product_type_id=products["Toilet"])
create_yolo_training_config("C:/Users/Liva Ausma/Documents/WORK/DFKI/DVC/AI/training_folder/dataset", product_specific=False, product_type_list_names=["Toilet", "Bathtub", "Sink"])
